...
bool OpRunner::RunOp()
{
    ...
    auto ret = aclnnArgMaxWithValueGetWorkspaceSize(inputTensor_[0],  opDesc_->dimension,opDesc_->keep_dims,
    ...
    ret = aclnnArgMaxWithValue(workspace, workspaceSize, handle, stream);
